...
pub struct ClientCapabilities {
    ...
    >,
    /**Optional MCP extensions that the client supports (SEP-1724 / MCP Apps `io.modelcontextprotocol/ui`).*/
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
...
pub struct ServerCapabilities {
    ...
    pub experimental: ::std::option::Option<
        std::collections::BTreeMap<::std::string::String, ::serde_json::Map<::std::string::String, ::serde_json::Value>>,
    >,
    /**Optional MCP extensions that the server supports (SEP-1724 / MCP Apps `io.modelcontextprotocol/ui`).*/
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub extensions: ::std::option::Option<
        std::collections::BTreeMap<::std::string::String, ::serde_json::Map<::std::string::String, ::serde_json::Value>>,
    >,

...
baml_function_sync!(CompareSeedPlans(intent: impl AsRef<str> + BamlEncode, plan_a: &types::SeedPlanRow, plan_b: &types::SeedPlanRow, ) -> (stream_types::PlanComparison, types::PlanComparison));


baml_function_sync!(ExtractDomainModel(api_summary: impl AsRef<str> + BamlEncode, ) -> (stream_types::DomainModel, types::DomainModel));


baml_function_sync!(ExtractMissingEntities(api_summary: impl AsRef<str> + BamlEncode, missing_entity_names: impl AsRef<str> + BamlEncode, known_refs: impl AsRef<str> + BamlEncode, known_enums: impl AsRef<str> + BamlEncode, ) -> (stream_types::DomainModel, types::DomainModel));


baml_function_sync!(ExtractMissingSharedTypes(api_summary: impl AsRef<str> + BamlEncode, existing_entities: impl AsRef<str> + BamlEncode, missing_type_issues: impl AsRef<str> + BamlEncode, ) -> (stream_types::DomainModel, types::DomainModel));


baml_function_sync!(ExtractRequirementSlots(intent: impl AsRef<str> + BamlEncode, entity_glossary: &[types::EntityGlossaryRow], ) -> (stream_types::RequirementSlotExtraction, types::RequirementSlotExtraction));


baml_function_sync!(RerankDiscoveryCandidates(intent: impl AsRef<str> + BamlEncode, candidates: &[types::DiscoveryRerankCandidate], ) -> (stream_types::RerankedDiscovery, types::RerankedDiscovery));


baml_function_sync!(SelectRequirementWitnesses(intent: impl AsRef<str> + BamlEncode, brand_lock_catalogs: &[String], witnesses: &[types::RequirementWitnessRow], ) -> (stream_types::WitnessSelectionAssessment, types::WitnessSelectionAssessment));


baml_function_sync!(TranslatePlan(messages: &[types::PlanChatTurn], ) -> (stream_types::PlasmPlan, types::PlasmPlan));


baml_function_sync!(ValidateDomainModel(api_summary: impl AsRef<str> + BamlEncode, domain_model: impl AsRef<str> + BamlEncode, ) -> (stream_types::DomainModelValidation, types::DomainModelValidation));

...
pub(crate) use seeds::{
    ...
    build_plasm_context_tool_meta, format_session_churn_advisory, PlasmContextToolMetaParams,
    ...
    CapabilityExposurePlan, STALE_EXECUTE_BINDING_NOTICE,
};
...
pub(crate) use session::{
    apply_federate_exposure_wave, build_initial_exposure_wave, replay_teaching_exposure_waves,
    ExposureCatalogWave,
};
pub use session::{

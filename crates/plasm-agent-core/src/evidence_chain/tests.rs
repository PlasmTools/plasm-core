#[cfg(test)]
mod tests {
    use super::super::config::{evidence_chain_enabled, ENV_PLASM_EVIDENCE_CHAIN, ENV_PLASM_EVIDENCE_SIGNING_KEY};
    use super::super::error::EvidenceEmitError;
    use super::super::plan::chain;
    use super::super::records::{RunSealRecord, StepExecutedRecord};
    use super::super::session::EvidenceChainSession;

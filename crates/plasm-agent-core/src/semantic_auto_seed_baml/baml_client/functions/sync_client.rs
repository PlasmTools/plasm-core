...
baml_function_sync!(SelectDiscoverySeeds(intent: impl AsRef<str> + BamlEncode, provider_groups: &[types::SeedBundleProviderGroup], candidate_bundles: &[types::CandidateSeedBundle], ) -> (stream_types::SeedCoverageAssessment, types::SeedCoverageAssessment));

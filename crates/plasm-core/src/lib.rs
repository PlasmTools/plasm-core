...
pub use schema::{
    ...
    AttachmentMediaKind, AuthScheme, CapabilityEffect, CapabilityKind, CapabilityManifest,
    ...
    DataClassSeverity, DiscoveryCapabilityHints, DiscoveryEntityHints, DiscoveryRelationHints,
    ...
    ResourceSchema, ScopeAggregateKeyPolicy, ScopeRequirement, SemanticEffect, SinkClassName,
    StringSemantics, ValidationOp, ValidationPredicate, ValueDomainKey, ValueDomainSlot,
    ViewDefinition, ViewNodeSpec, ViewOutputBinding, ViewParamBinding, ViewRelationBinding,
    ViewRelationOutputSpec, ViewScopeInject, ViewScopeParam, WireVariantDiscriminator, CGS,
